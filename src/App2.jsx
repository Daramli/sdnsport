...
const translations = {
  ...
  en: {
    ...
    tshirtSalesDesc:
      "We provide top-quality shirts for local clubs and the national team.",
    ...
    kitsForTeamsDesc:
      "Service for preparing and ordering full team kits – launching soon.",
...
const prices = {
  مصر: {
    ...
    "SUDAN AWAY 24/25": "350 ",
    "SUDAN HOME 24/25": "350 ",
    "SUDAN ARMY": "350 ",
  },
  السودان: {
...
function App() {
  ...
  return (
    ...
    >
      ...
      {/* المنتجات */}
      <main className="p-4">
        <h3 className="text-2xl mb-4 text-center font-bold" id="products">
          {t.products}
        </h3>
          ...
          {[
            ...
            return (
              <div key={index} className="border rounded-lg p-4 shadow">
                ...
                <p className="mb-2">
                  {country &&
                    `${prices[country]?.[product]} ${t.currencies[country]}`}
                </p>
